...
Move the folders generated by this to the main folder where train.py exists.

## Dataset

The synthetic dataset used in this project is available for download:

🔗 https://drive.google.com/drive/folders/1RSzEFXfNirUAkmncI9NNWg2kQzOHh2X0?usp=drive_link

### Contents

- `graspable_patches_best.zip` — Graspable (positive) patch pairs  
- `nongraspable_patches_best.zip` — Non-graspable (negative) patch pairs  

These files are also included in this repository (via Git LFS).
